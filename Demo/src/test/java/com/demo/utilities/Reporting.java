...
public class Reporting extends TestListenerAdapter
{
	...
	{
		// get custom name to report every time
		String timeStamp = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss").format(new Date());//time stamp
		String repName="Test-Report"+timeStamp+".html";
		htmlReporter = new ExtentHtmlReporter(System.getProperty("user.dir") + "//test-output//Extended Reports//"+ " "+ repName);
		// location of report
	...
	public void onTestFailure(ITestResult tr)
	{
		...
		String screenshotPath=System.getProperty("user.dir")+"//Screenshots//"+tr.getName()+" "+ screenshotName+".png";
